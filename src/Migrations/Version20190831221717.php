 ...
 */
final class Version20190831221717 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, genre_id INT NOT NULL, editeur_id INT NOT NULL, auteur_id INT NOT NULL, isbn VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_AC634F994296D31F (genre_id), INDEX IDX_AC634F993375BD21 (editeur_id), INDEX IDX_AC634F9960BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
